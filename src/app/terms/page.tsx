    ...
    <>
      <div className="mx-3 mt-3 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 px-5 py-6">
        ...
        <p className="text-[11px] text-white/60 mt-1.5">
          Договір роздрібної купівлі-продажу · останнє оновлення: 16.08.2026
        </p>
      </div>
      ...
      <div className="px-4 py-6 text-[13px] text-gray-700 leading-relaxed space-y-5">
        ...
        <div>
          ...
          <p>
            Продавець — ФОП Лата Тетяна Олександрівна (реквізити зазначені в
            кінці документа). Покупець — будь-яка дієздатна фізична особа,
            яка оформлює замовлення на сайті.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600">
            ФОП Лата Тетяна Олександрівна
            <br />
            РНОКПП / ЄДРПОУ: 3579903289
            <br />
            Адреса реєстрації: Україна, Запорізька обл., Запорізький р-н,
            с. Михайлівка, вул. Степова, буд. 21
            <br />
        ...
        <p className="text-[11px] text-gray-400 border-t border-gray-100 pt-4">
          Рекомендуємо перевірку цього документа юристом перед офіційним
          запуском продажів.
        </p>
      </div>
